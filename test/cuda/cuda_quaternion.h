...
/**
 * Calculate a 4x4 Transformation matrix given a 3x3 rotation matrix and translation vector on GPU
 *
 * @param trans 4x4 Transformation Matrix
 * @param t 3-element translation representation
 * @param r 3x3 Rotation Matrix
 */
__device__ __host__
void calc_trans_from_tr(float *trans, const float *t, const float *r);
